...
void ShowActiveNote(int event, int note ){
  ...
  while(client.available()){
    ...
    if(str != ""){
      ...
      if(eventsGet == 2){
        ...
        ShowActiveNote(valActive1.toInt(), note1.toInt());
        ...
        ShowActiveNote(valActive2.toInt(), note2.toInt());     
      }
